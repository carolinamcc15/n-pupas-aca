...
const PurchaseTableRow = ({ purchase, extended = false, onDeleteHandler = null }) => {
  ...
  return (
    <tr className='bg-white border-[1px] border-primary-300'>
      <td className='text-center px-3 py-2 whitespace-nowrap border-r-[1px] border-primary-300 truncate'>
        {purchase.concept}
      </td>
      <td className='px-3 py-2 border-primary-300 border-r-[1px] whitespace-nowrap'>
